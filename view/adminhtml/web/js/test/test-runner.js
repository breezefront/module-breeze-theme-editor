/**
 * Breeze Theme Editor Test Runner (Admin Context)
 * 
 * Main component that manages test execution and UI updates in admin area
 */
define([
    'jquery',
    ...
    return function(config, element) {
        ...
        function loadTests() {
            ...
            require(testModules, function() {
                ...
                console.log('✅ Loaded', loadedSuites.length, 'test suites (Admin Context)');
                ...
                if (config.autoRun) {
                    console.log('▶ Auto-running tests (Admin Context)...');
                    // Wait 2s to allow toolbar/panel initialization
        ...
        function runAllTests() {
            ...
            TestFramework.runSuites(loadedSuites, function(results) {
                ...
                console.log('✅ Tests completed in ' + duration + 'ms (Admin Context)');
        ...
        function copyResultsToClipboard() {
            ...
            var text = '🧪 Breeze Theme Editor Test Results (Admin)\n';
            text += '═══════════════════════════════════════\n\n';
