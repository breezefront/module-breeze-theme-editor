...
define([
    ...
    'Swissup_BreezeThemeEditor/js/editor/utils/permissions',
    'Swissup_BreezeThemeEditor/js/editor/utils/error-handler',
    'Swissup_BreezeThemeEditor/js/editor/utils/loading',
